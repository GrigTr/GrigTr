...
| 2.   | [Оценка эффекта маркетингового мероприятия на метрики продукта](https://github.com/GrigTr/DA_DS_analysis.git) | Оценка эффективности флешмоба через анализ ключевых метрик продукта. | Pandas, Seaborn, CasualImpact      |
