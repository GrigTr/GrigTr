...
---
https://github.com/GrigTr/forecasting-metrics.git
## 🎆 My projects
...
| 2.   | [Прогнозирование эффекта на метрики продукта после маркетингового мероприятия](https://github.com/GrigTr/DA_DS_analysis.git) | Оценка эффективности флешмоба через анализ ключевых метрик продукта. | Pandas, Seaborn, CasualImpact      |
